...
En el capítulo 1 ya se entregaron algunos antecedentes que permiten reconocer las dificultades de los pacientes adultos a recibir sus  tratamientos, consultas y examenes planificados a  causa de la pandemia por COVID-19 (año 2020). 

En este sentido, una de las principales razones declaradas por las personas por las que no pudieron seguir sus tratamientos planificados fue que los centros de salud les habían anulado o postergado la hora. Esta situación se dió por la saturación de los establecimientos de salud exigiendo equipo y personal de salud. 

En este sentido, es posible que estos problemas se hayan transferido a atenciones de salud enfocadas en niños, tales como el programa de control de niño sano y el programa de inmunizaciones. Situación que se puede haber visto agravada por el cierre de los recintos escolares. 

Lamentablemente, no existen preguntas específicas en la encuesta que permitan profundizar en esta temática. 

#### Programa Control Niño Sano

Como se informa en la web oficial de [Chile Crece Contigo](https://www.crececontigo.gob.cl/beneficios/control-de-salud-de-nino-y-nina-sano-en-establecimientos-educacionales/), el programa de Control Niño Sano  consiste en un beneficio que permite que niños y niñas de 5 años en adelante pueden ser tanto en el Centro de salud como en el establecimiento educacional. Las principales actividades a realizar en el control son la evaluación del desarrollo integral y crecimiento del niño o la niña, junto con orientar y resolver las dudas que las madres, padres y/o cuidadores tengan al respecto.

Esta atención considera las siguientes prestaciones: revisión de antecedentes generales y de riesgo biopsicosocial, examen físico cefalocaudal, revisión dental, evaluación pondoestatural, control de presión arterial, screening visual, auditivo y respiratorio, y revisión de plan de vacunación.

Junto con realizar el control de salud de niño y niña sano(a), este programa realiza las derivaciones al centro de salud según el problema pesquisado. Adicionalmente, se trabaja con los profesores y se les capacita en riesgos de salud.
...
Entre las enfermedades consideradas para vacunación en lactantes se encuentran: 
...
Y  para los pre-escolares y escolares se encuentran: 
...
graph_barras_bivariado(tabulados_razones_no_vacunacion_df,
                       titulo = "¿Por qué razón o razones es poco o nada probable que ud. se vacune?")
...
graph_barras_univariado(confianza_autoridades_sanitarias,
                       titulo = "Confío en que las autoridades sanitarias toman decisiones sobre la vacunación pensando en el bienestar de la población")
...
No existen preguntas que directamente permitan evaluar la efectividad de distintas estrategias para aumentar la tasa de vacunación. No obstante, en la segunda versión del cuestionario (2022) se pregunta a las personas si consideran que *"Obtener el pase de movilidad una motivación importante para que las personas se vacunen"* (d12.9). 

Respecto a esta pregunta, se observa que el 80% (IC95% 77.1-83.0) de las personas estaría de acuerdo o muy de acuerdo con esta afirmación y un 13.8% (IC95% 11.2-16.3) estaría en desacuerdo o muy en desacuerdo.
...
graph_barras_univariado(motivacion_pase,
                       titulo = "Obtener el Pase de Movilidad es una motivación importante para que las personas se vacunen")

```

Al desagregar por sexo y principal medio de información no se encontraron diferencias. Sin embargo, existen diferencias por tramo etario, donde  se observa que entre las personas de 60 años o más  solo un grupo entorno al 8.0% (IC95% 5.1-10.8) estaría en desacuerdo o muy en desacuerdo con esta frase, en contraste con el 17.1% (IC95% 13.5-20.8) de las personas entre 30 y 59 años. En este sentido, se podría afirmar que las personas de 60 años o más están más dispuestas a acatar normas de las autoridades sanitarías incluso si no están de acuerdo, en comparación con el grupo de 30 a 59 años. 
...
graph_barras_bivariado(motivacion_pase_edad,
                       titulo = "Aunque a veces no estemos de acuerdo con las autoridades sanitarias y las medidas que se proponen, es nuestro deber seguir sus indicaciones al pie de la letra")

```

También se comparó la aprobación del gobierno respecto a las medidas para combatir la pandemia, pidiendo a las personas dar su nivel de acuerdo con la siguiente frase: "Las medidas que el
gobierno actual está adoptando para proteger a la población del coronavirus han sido las adecuadas" (pregunta f3.4 en 2020 y e1.5 en cuestionario 2022). Al respecto, es importante mencionar que una de las principales diferencias entre ambos años sería el despliegue de la campaña de vacunación contra el covid-19 y  el relajamiento  de restricciones a la movilización de las personas, condicionada al pase de movilidad (interiores) y la fase epidemiológica de los territorios. 

De esta manera, se observa un aumento significativo en la aprobación del gobierno relacionado cone sta temática, aumentando de un 41.7% (IC95% 38.3-45.2)en 2020 a 60.1% (IC95%56.5-63.6) en 2022. 
...
graph_barras_univariado(antivacunas,
                       titulo = "Porcentaje población que acepta o rechaza inmunizaciones en general")
```
...
graph_barras_bivariado(long_covid_2022_sexo, 
                       titulo = "Personas con sintomas que duraron más de un mes tras COVID-19 según sexo")
```
...
graph_barras_bivariado(long_covid_2022_edad, 
                       titulo = "Personas con sintomas que duraron más de un mes tras COVID-19 según tramo etario")
```
...
graph_barras_bivariado(long_covid_2022_cronicos, 
                       titulo = "Personas con sintomas que duraron más de un mes tras COVID-19 según padecimiento de enfermedad crónica")
```
...
graph_barras_univariado(salud_mental_2020, 
                       titulo = "Prevalencia de sintomas de ansiedad y depresión")
```
...
graph_barras_bivariado(salud_mental_2020_sexo, 
                       titulo = "Prevalencia de sintomas de ansiedad y depresión según sexo")
```
...
graph_barras_bivariado(salud_mental_2020_edad, 
                       titulo = "Prevalencia de sintomas de ansiedad y depresión según tramo etario")
```
